...
namespace ELifeRPG.Infrastructure.Migrations
{
    ...
    [Migration("20230222232916_AddShops")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELifeRPG.Domain.Items.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ELifeRPG.Domain.Items.Prefab", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_Prefab_Id");

                    b.HasIndex("FK_Item_Id")
                        .IsUnique();

                    b.ToTable("Prefab", (string)null);
                });

            modelBuilder.Entity("ELifeRPG.Domain.Shops.Shop", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ELifeRPG.Domain.Shops.ShopListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("FK_Shop_Id")
                        .HasColumnType("uuid");

                    b.HasKey("Id")
                        .HasName("PK_ShopListing_Id");

                    b.HasIndex("FK_Item_Id");

                    b.HasIndex("FK_Shop_Id");

                    b.ToTable("ShopListing", (string)null);
                });
            ...
            modelBuilder.Entity("ELifeRPG.Domain.Items.Prefab", b =>
                {
                    b.HasOne("ELifeRPG.Domain.Items.Item", "Item")
                        .WithOne("Prefab")
                        .HasForeignKey("ELifeRPG.Domain.Items.Prefab", "FK_Item_Id")
