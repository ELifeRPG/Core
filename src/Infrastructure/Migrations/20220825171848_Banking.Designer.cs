...
namespace ELifeRPG.Infrastructure.Migrations
{
    ...
    [Migration("20220825171848_Banking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELifeRPG.Domain.Banking.BankAccountTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("Id");
                    ...
                    b.Property<Guid>("FK_Bank_Target_Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_BankAccountTransaction_Id");

                    b.HasIndex("FK_Bank_Id");

                    b.HasIndex("FK_Bank_Target_Id");
            ...
            modelBuilder.Entity("ELifeRPG.Domain.Banking.BankAccountTransaction", b =>
                {
                    b.HasOne("ELifeRPG.Domain.Banking.BankAccount", "Target")
